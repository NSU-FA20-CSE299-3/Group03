...
reduce transaction costs by removing many of the geographic and time barriers that
buyers and sellers previously faced. It will also save time of its users as it they will not have
to go outside to buy their products. The app is not yet in a complete as i couldn't finish the order confirming process from admin panel. Hope to do it in the futre and make it more user friendly and more efficient. 
